...
public class PermissionClass {
    ...
    public JavaFile generateFile() {
        TypeSpec.Builder typeBuilder = TypeSpec.classBuilder(getClassName() + "_Permissions")
                ...
                .addMethod(buildCheckPermissionMethod())
    ...
    /**
     * boolean checkPermissions(String[] permissions, int requestCode);
     * <p>
     ...
     * @return
     */
    private MethodSpec buildCheckPermissionMethod() {
        MethodSpec.Builder method = MethodSpec.methodBuilder("checkPermissions")
                .addModifiers(Modifier.PUBLIC)
                .addParameter(String[].class, "permissions", Modifier.FINAL)
                .addAnnotation(Override.class)
                .returns(TypeName.BOOLEAN)
                .addStatement("return $T.hasSelfPermissions(target, permissions)", PERMISSIONS_CLASS);
        return method.build();
    }
    ...
    private static final ClassName ACTION_CLASS = ClassName.get("permission.api", "Action");
    private static final ClassName PERMISSIONS_CLASS = ClassName.get("permission.api", "Permissions");
}
